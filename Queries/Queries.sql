    ...
    --Drop retirement info table to form a new table with emp_no
    ...
    -- Use Aliases for Code Readability. Joining RI with de
    SELECT ri.emp_no,
        ri.first_name,
        ri.last_name,
        de.to_date
    ...
    -- Use Left Join for retirement_info and dept_emp tables and save new table
    SELECT ri.emp_no,
        ri.first_name,
        ri.last_name,s
        de.to_date
